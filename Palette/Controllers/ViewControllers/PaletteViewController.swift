...
class PaletteViewController: UIViewController {
    ...
    func searchForCategory(_ unsplashRoute: UnsplashRoute){
        UnsplashService.shared.fetchFromUnsplash(for: unsplashRoute) { photos in
            DispatchQueue.main.async {
                guard let photots = photos else { return }
                self.photos = photots
    ...
    func configureTableView(){
        ...
        paletteTableView.register(PaletteTableViewCell.self, forCellReuseIdentifier: "phototCell")
    }
...
extension PaletteViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "phototCell", for: indexPath) as? PaletteTableViewCell else { return UITableViewCell() }
